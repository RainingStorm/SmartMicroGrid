...
plt.show()
print(PB)
np.savetxt('./res/PB.csv', PB, fmt='%.7f', delimiter=',')
np.savetxt('./res/soc.csv', soc, fmt='%.7f', delimiter=',')
np.savetxt('./res/PG.csv', PG, fmt='%.7f', delimiter=',')
np.savetxt('./res/DG1.csv', DG1, fmt='%.7f', delimiter=',')
np.savetxt('./res/DG2.csv', DG2, fmt='%.7f', delimiter=',')
np.savetxt('./res/PREG1.csv', PREG1, fmt='%.7f', delimiter=',')
np.savetxt('./res/PREG2.csv', PREG2, fmt='%.7f', delimiter=',')
np.savetxt('./res/LMP.csv', LMP, fmt='%.7f', delimiter=',')