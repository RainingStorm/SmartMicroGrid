...
class TDQN:
    ...
    def update(self):
        ...
        next_target_values = torch.min(target_Q1, target_Q2)   # 为防止过高估计动作价值，target_Q采用较小值
        ...
        if self.total_it % self.policy_freq == 0:
            ...
            policy_loss = self.critic.Q(state, self.actor(state))   # 为使Actor在两个Q上均得到较大值，取两个Q之和来训练
